...
// 2. Skema warna DARK (yang baru saja kamu berikan)
const darkColors = {
	primary: "rgb(186, 26, 32)",
	onPrimary: "rgb(255, 255, 255)",
...
// 3. Gabungkan ke Theme Provider
// 3. Gabungkan ke Theme Provider + Tambahkan Roundness
export const AppLightTheme = {
	...MD3LightTheme,
	colors: lightColors,
	roundness: 2, // <--- TAMBAHKAN INI (0: Kotak, 1: Standar, 2+: Bulat Lembut)
};

export const AppDarkTheme = {
	...MD3DarkTheme,
	colors: darkColors,
	roundness: 2, // <--- TAMBAHKAN INI JUGA
};
